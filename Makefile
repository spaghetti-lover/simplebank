...
migrateup:
	migrate -path db/migration -database "postgresql://root:narutora12345@simple-bank.c7eygqewid0u.us-east-1.rds.amazonaws.com/simple_bank?sslmode=disable" -verbose up
